public static class ArraysTester {
    ...
    private static double[] MultiplesOf(double number, int length)
    {
        ...
        {
            // Calculate the current multiple by multiplying the starting number by the loop counter.
            double currentMultiple = number * i;
    ...
    private static void RotateListRight(List<int> data, int amount)
    {
        ...
        // Remove the specified number of elements from the end of the data list and add them to the temporary list.
        ...
        // Insert the temporary list into the beginning of the data list.
